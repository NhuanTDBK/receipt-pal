...
Backed by ``poc/data/faq.md``.  Matching is a simple keyword search over
the corpus so answers remain deterministic and require no DB or LLM call.
"""
...
def _load_corpus() -> str:
    try:
        ...
        # Strip HTML comments before parsing so developer notes don't match.
